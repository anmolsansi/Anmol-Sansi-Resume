  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        <Link to="/" className="brand" onClick={() => setOpen(false)}><span className="brand-mark"><img src={profileImage} alt="Anmol Sansi" /></span><span><strong>{profile.name}</strong><small>{profile.title}</small></span></Link>
      ...
      <footer className="site-footer">
        <div className="brand"><span className="brand-mark"><img src={profileImage} alt="Anmol Sansi" /></span><span><strong>{profile.name}</strong><small>{profile.title}</small></span></div>
